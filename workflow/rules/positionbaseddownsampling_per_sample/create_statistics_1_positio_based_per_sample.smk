...
rule aggregate_stats_ds_1_perc:
    ...
    output:
        sample_stats=config['results_folder']+"/ds_1_percent_position_based_per_sample/insert_{bin_start}-{bin_end}/stats.tsv",
    shell:
        """
...
rule merge_stats_ds_1_perc:
    ...
    output:
        aggregate_stats=config['results_folder']+"/ds_1_percent_position_based_per_sample/statistics_ds_1_pos_per_sample.tsv"
    shell:
        """
